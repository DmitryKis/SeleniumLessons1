...
public class AdminPage {
    ...
    private static final String MENU_ITEM_PATH = "//div[@id='box-apps-menu-wrapper']//li[starts-with(@id,'app-')]";
    private static final String SUBMENU_ITEM_PATH = "//div[@id='box-apps-menu-wrapper']//li[starts-with(@id,'doc-')]";
